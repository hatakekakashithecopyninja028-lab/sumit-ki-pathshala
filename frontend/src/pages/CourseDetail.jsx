    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <button
          ...
          className="flex items-center space-x-2 text-primary hover:text-accent transition-colors mb-8"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm" data-testid="course-details">
              ...
              <h1 className="text-3xl sm:text-4xl font-bold text-primary mb-4">{course.title}</h1>
              ...
              <div className="pt-6 mt-6 border-t border-border">
                <h2 className="text-2xl font-bold text-primary mb-4">Course Features</h2>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg sticky top-20" data-testid="purchase-card">
              ...
              <div className="space-y-3 pt-4 border-t border-border">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-semibold text-primary">{course.teacher_name}</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="text-muted-foreground">Class</span>
                  <span className="font-semibold text-primary">Class {course.class_level}</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="text-muted-foreground">Subject</span>
                  <span className="font-semibold text-primary">{course.subject}</span>
                </div>
              </div>
